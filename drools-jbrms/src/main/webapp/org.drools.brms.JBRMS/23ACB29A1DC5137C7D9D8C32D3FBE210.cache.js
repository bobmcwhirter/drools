...
function Efc(c,b){var a;a=FI(new pI());a.si('constraint-value-Editor');if(b.c===null){AI(a,'');}else{AI(a,b.c);}if(b.c===null||Erb(b.c)<5){bJ(a,3);}else{bJ(a,Erb(b.c)-1);}sI(a,efc(new dfc(),c,b,a));tI(a,sJb(new rJb(),ifc(new hfc(),c,a)));if(zrb(c.c.b,'Numeric')){tI(a,egc(a));}return a;}
...
function Ehc(c,b){var a;a=FI(new pI());a.si('constraint-value-Editor');if(b.f===null){AI(a,'');}else{AI(a,b.f);}if(b.f===null||Erb(b.f)<5){bJ(a,3);}else{bJ(a,Erb(b.f)-1);}sI(a,ohc(new nhc(),c,b,a));tI(a,sJb(new rJb(),shc(new rhc(),c,a)));return a;}
...
function dlc(c,b){var a,d,e;if(c.a&& !h_b(c.d.c,c.e.a)){d=Ex(new Cx());e=FI(new pI());if(c.e.a===null){AI(e,'');}else{AI(e,c.e.a);}bJ(e,3);Fx(d,e);a=gp(new Fo(),'Set');a.w(gjc(new fjc(),c,e,b));Fx(d,a);eKb(b,'Variable name',d);}}
